    ...
    <div className="space-y-6">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <div className="bg-[#071830] border border-sky-500/20 w-full sm:max-w-lg rounded-t-2xl sm:rounded-2xl relative z-10 shadow-2xl shadow-black/50 flex flex-col max-h-[92dvh] sm:max-h-[calc(100dvh-3rem)]">
