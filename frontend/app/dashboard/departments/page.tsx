          ...
          <div className="bg-[#071830] border border-sky-500/20 max-w-lg w-full rounded-2xl p-6 relative z-10 shadow-2xl shadow-black/50 flex flex-col max-h-[90vh]">
            <div className="flex items-center justify-between mb-4 shrink-0 border-b border-sky-500/10 pb-3">
              <div>
                ...
                <p className="text-xs text-sky-300/40 mt-0.5">
            ...
            {error && (
              <div className="bg-red-500/8 border border-red-500/20 text-red-400 p-3 rounded-xl text-xs mb-4 flex items-center gap-2 shrink-0">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col min-h-0 flex-1">
              <div className="flex-1 overflow-y-auto pr-1.5 space-y-4 scrollbar-thin scrollbar-thumb-sky-500/20 scrollbar-track-transparent">
              ...
              <div className="flex justify-end gap-3 pt-4 mt-4 border-t border-sky-500/10 shrink-0">
                <button
                  ...
                  className="px-5 py-2.5 border border-sky-500/20 hover:bg-white/5 text-sm text-sky-300 rounded-xl transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button
