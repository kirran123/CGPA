  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="h-16 flex items-center gap-3 px-5 border-b border-sky-900/40 shrink-0">
        <div className="flex-shrink-0 h-9 w-9 rounded-full overflow-hidden border border-sky-500/30 shadow-md shadow-sky-500/20 bg-white/90 flex items-center justify-center">
