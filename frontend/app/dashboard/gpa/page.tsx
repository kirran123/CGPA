                ...
                <div className="space-y-3 max-h-[460px] overflow-y-auto pr-1">
                  ...
                  {rows.map((row, idx) => (
                    <div
                      ...
                      className={`grid grid-cols-1 md:grid-cols-12 gap-2 p-2.5 rounded-xl border transition-all duration-150 animate-fade-in-up items-center ${row.isEditing
                    ...
                    >
                      ...
                      <div className="col-span-2">
                        <input
                          ...
                          className={`w-full rounded-lg px-2 py-1 text-[11px] font-mono font-bold focus:outline-none transition-all ${row.isEditing
                      ...
                      <div className="col-span-5">
                        <input
                          ...
                          className={`w-full rounded-lg px-2 py-1 text-[11px] sm:text-xs focus:outline-none transition-all ${row.isEditing
                      ...
                      <div className="col-span-1">
                        <input
                          ...
                          className={`w-full rounded-lg px-1 py-1 text-xs font-semibold text-center focus:outline-none transition-all ${row.isEditing
                              ? 'bg-[#071830] border-2 border-amber-400 text-amber-300 ring-2 ring-amber-400/20'
                      ...
                      <div className="col-span-2 flex items-center justify-center gap-1.5">
                        <button
                          ...
                          className={`p-1.5 rounded-lg transition-all cursor-pointer flex items-center gap-1 text-[10px] font-semibold ${row.isEditing
